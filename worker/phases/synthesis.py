...
Write a caller brief with EXACTLY this structure (use the bold headers as shown):
...
**PITCH:** Which of our services to lead with and exactly why based on what we found (be specific — e.g. "Lead with SEO because their site has no meta descriptions and a Yelp rating of 3.2 suggests reputation issues")

**ASK FOR:** The specific person name and title to ask for when the call connects (use data if available, otherwise suggest by title)
